		...
		if(!TentDimension.isTentDimension(worldIn))
		{
			...
			else if(hasInvalidCoords(stack))
			{
				if(worldIn.isRemote)
				{
					...
					player.addChatMessage(new TextComponentTranslation(TextFormatting.RED + I18n.format("chat.no_structure_ln1")));
					player.addChatMessage(new TextComponentTranslation(TextFormatting.RED + I18n.format("chat.no_structure_ln2")));
					player.addChatMessage(lines);
				}
