...
public class DynamicDimensionHelper {
    ...
    /**
     * @param level a world
     * @return true if the world is a tent (the namespace is {@link NomadicTents#MOD_ID})
     */
    ...
    public static boolean isInsideTent(final ResourceLocation dimensionId) {
        ...
        return NomadicTents.MOD_ID.equals(dimensionId.getNamespace());
    }
    ...
    public static ServerLevel getOrCreateWorld(MinecraftServer server, ResourceKey<Level> levelKey,
        ...
        return infiniverse.getOrCreateLevel(server, levelKey, () ->
