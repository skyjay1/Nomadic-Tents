...
public class CommonProxy {
	...
	public void registerBlocks(final RegistryEvent.Register<Block> event) {
		event.getRegistry().registerAll(
				...
				new BlockYurtWall("yurt_wall_inner"),
				...
				new BlockTentDoorSML("bedouin_door_0"),
				new BlockTentDoorHGM("bedouin_door_1"),
				...
				new BlockCosmetic.BedouinWall("cos_bedouin_wall"),
				new BlockCosmetic(Properties.create(Material.CLOTH, MaterialColor.WOOD), "cos_bedouin_roof"),
	...
	public void registerDimension(final RegistryEvent.Register<ModDimension> event) {
		DimensionManagerTent.setup(null);
		event.getRegistry().register(Content.TENT_DIMENSION);
	}
	...
	public void registerTileEntity(final RegistryEvent.Register<TileEntityType<? extends TileEntity>> event) {
		...
		// .setRegistryName(NomadicTents.MODID, name)
...
//		event.getRegistry().register(tileentity);
	...
	private static final ItemBlock makeIB(final Block base) {
