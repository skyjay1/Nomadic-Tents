...
public class Config {
	...
	public static void mainRegistry(Configuration config) {
		...
		NUM_YURT_WALL_OUTPUT = config.getInt("Yurt Output Amount", CATEGORY_CRAFTING, 1, 1, 6,
		...
		NUM_TEPEE_WALL_OUTPUT = config.getInt("Tepee Output Amount", CATEGORY_CRAFTING, 1, 1, 6,
				"Number of Tepee Wall Pieces generated by one recipe");

		REQUIRE_CARPET = config.getBoolean("Require Carpet", CATEGORY_CRAFTING, false,
				"When true, the Bedouin Wall recipe requires 4 carpet instead of 4 wool");
		NUM_BED_WALL_OUTPUT = config.getInt("Bedouin Output Amount", CATEGORY_CRAFTING, 1, 1, 6,
				"Number of Bedouin Wall Pieces generated by one recipe");
		
		NUM_INDLU_WALL_OUTPUT = config.getInt("Indlu Output Amount", CATEGORY_CRAFTING, 1, 1, 6,
