...
public class StructureData implements net.minecraftforge.common.util.INBTSerializable<NBTTagCompound> {
	...
	public IBlockState getRoofBlock(final World worldIn) {
		return this.tent.getRoofBlock(worldIn);
	}
	...
	public IBlockState getWallBlock(final World worldIn) {
		return this.tent.getWallBlock(worldIn);
	}
	...
	public static void applyToTileEntity(final EntityPlayer player, final ItemStack stack, final TileEntityTentDoor te) {
		if (!stack.getOrCreateTag().hasKey(ItemTent.TENT_DATA)) {
	...
	public ItemStack getDropStack() {
		...
		stack.getOrCreateTag().setTag(ItemTent.TENT_DATA, this.serializeNBT());
		return stack;
	}
	...
	public NBTTagCompound serializeNBT() {
		...
		if(this.tent != null) {
			...
			nbt.setInt(KEY_OFFSET_X, this.offsetX);
			nbt.setInt(KEY_OFFSET_Z, this.offsetZ);
		}
	...
	public void deserializeNBT(final NBTTagCompound nbt) {
		...
		this.offsetX = nbt.getInt(KEY_OFFSET_X);
		this.offsetZ = nbt.getInt(KEY_OFFSET_Z);
	}
